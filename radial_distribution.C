...
////Change the following lines for which detectors you want to include////
   string detH[] = {"det173","det28","det30","det174","det175","det176","det31"};
//just downstream of target, ring 5, showermax, LAM, US scanner, SAM location in remoll, SAM location in CAD
   const int nDet = sizeof(detH)/sizeof(*detH);
   const int Det[nDet] = {173,28,30,174,175,176,31};
   map<int,int> dtM {{173,1},{28,2},{30,3},{174,4},{175,5},{176,6},{31,7}};
/////////////////////////////////////////////////////////////////////////
...
////Change the following lines as needed////
   ...
   int beamGen(1);
   const string config = "V1";//if no congit, set it to V1
///////////////////////////////////////////
...
////Change this line for appropriate rootfiles////
       string infile = Form("%s/Optics1_beam/Optics1_beam_%d.root",
