...
void rad_trans_electron_beam(){
   ...
   double x_max1D[nDet] = {1500,1500,1000};
   double x_min2D[nDet] = {-2000,-2000,-2000};
   double x_max2D[nDet] = {2000,2000,2000};
   ...
   for(int iDet=0;iDet<nDet;iDet++){
      ...
      int nbin2D = (x_max2D[iDet]-x_min2D[iDet])/10;
...
//Now combine all pdf files saved in ./temp/ directory and save a single pdf file in ./plots/ directory
   gSystem->Exec(Form("pdfunite ./temp/*.pdf ./plots/rad_trans_dist_electron_beam.pdf"));
